...
int main() {
    ...
    if ( input % 4 == 0 ) {
        if ( input % 100 == 0 ) {
            if ( input % 400 == 0 ) {
                printf( "February has 29 days" ) ; //หาร 4 ลงตัว หาร 100 ลงตัว หาร 400 ลงตัว
            } else {
                printf( "February has 28 days" ) ; //หาร 4 ลงตัว หาร 100 ลงตัว หาร 400 ไม่ลงตัว
            }//end if else หาร 400
            
        } else {
            printf( "February has 29 days" ) ;  //หาร 4 ลงตัว หาร 100 ไม่ลงตัว
        }//end if else หาร 100
        
    } else {
        printf( "February has 28 days" ) ; //หาร 4 ไม่ลงตัว
    }//end if else หาร 4
